...
"""
  ...
  stages {
    ...
    stage('Deploy') {
      environment {
        GIT_CREDS = credentials('github-nook')
        HELM_GIT_REPO_URL = "github.com/pornpoi/rsvpapp-helm-cicd.git"
        GIT_REPO_EMAIL = 'inpang_nook@hotmail.com'
